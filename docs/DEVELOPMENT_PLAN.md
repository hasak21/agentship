...
- [~] Add baselines, suppressions with ownership, and report history (exact warning suppressions with owner/reason/expiry and cross-format evidence delivered; baseline comparison and durable history pending).
